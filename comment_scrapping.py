...
page_name = "jypnationzone"
url = "https://www.facebook.com/jypnationzone"
...
def scrape():
    driver.get(url)
    elements = driver.find_elements(By.CSS_SELECTOR, "span.d2edcug0.hpfvmrgz.qv66sw1b.c1et5uql.lr9zc1uh.a8c37x1j")
